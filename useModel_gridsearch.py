...
model = tf.keras.models.load_model("grid_search_results.keras")



scaler_X = joblib.load("grid_search_scaler_X.pkl")
scaler_y = joblib.load("grid_search_scaler_y.pkl")
...
def predict_kp_ki():
    while True:
        try:
            ...
            print(f"Actual ITAE0: {ca.ITAE((predicted[0][0],predicted[0][1]))}")
